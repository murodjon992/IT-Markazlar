        ...
        <div class="flex items-center justify-center md:w-1/3 form_blog">
          <form class="w-full pupil_form flex" method="POST" action="#">
            ...
            <label class="block text-sm">
              ...
              <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" type="text" name="name" value="<?= $isEdit ? $user['name'] : ''?>" placeholder="Suyunbek..." required>
            </label>
            <label class="block text-sm ">
              <span class="text-gray-700 dark:text-gray-400">Familiyasi</span>
              <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" type="text" name="surname" value="<?= $isEdit ? $user['surname'] : ''?>" placeholder="Saydazimov..." required>
            </label>
            <label class="block text-sm ">
            ...
            <label class="block text-sm ">
              ...
              <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" type="text" name="address" placeholder="Buloqboshi..." value="<?= $isEdit ? $user['address'] : ''?>" required>
            </label>
            <label class="block text-sm ">
            ...
            <label class="block text-sm ">
              ...
              <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" type="text" name="dev_type" placeholder="Frontend..." value="<?= $isEdit ? $user['dev_type'] : ''?>" required>
            </label>           
            <label class="block mt-4 text-sm">
              <span class="text-gray-700 dark:text-gray-400">Parol</span>
              <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="password" placeholder="***************" type="password" value="<?= $isEdit ? $user['password'] : ''?>" required>
