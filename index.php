...
<body>
    <nav class="navbar navbar-expand-sm navbar-light bg-light w-100 p-2 bg-dark">
        <a href="index.php" class="navbar-brand">Buloqboshi <span class="text-danger"> Ustalari</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul class="navbar-nav">
                ...
                <li class="nav-item custom_nav"><a href="" class="nav-link">Galereya</a></li>
                <li class="nav-item custom_nav"><a href="" class="nav-link">Ustalar</a></li>
                <li class="nav-item custom_nav"><a href="" class="nav-link">Narxlari</a></li>
            </ul>
        </div>
        <!-- <div class="ser"> -->
        ...
        if (isset($_SESSION['is_login'])) { ?>
            ...
            <a href="#" class='btn btn-warning ml-4' title='Profil haqida' title="Profilga kirish">Dashboard</a>
        <?
        } else {?>
    ...
    <div class="container-fluid">
        <div class="vid-parent">
            ...
            <div class="vid-content">
                <h1 class="my-content text-white">Buloqboshi Ustalariga Xush kelibsiz!</h1> <br>
